...
import me.fulln.base.common.properties.OrderdProperties;
...
public class FileUtil {
    ...
    synchronized static private void loadProps(Class clazz,String name) {
        String extension = name.substring(name.lastIndexOf(FileExtensionConfig.FILE_DOT) + 1);
        if (extension.equals(FileExtensionConfig.FILE_PROPERTIES)) {
            //按顺序加载properties
        ...
        } else if (extension.equals(FileExtensionConfig.FILE_YML)) {
            //加载yml
            try {
