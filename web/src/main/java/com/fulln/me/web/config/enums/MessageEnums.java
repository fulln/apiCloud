...
import com.fulln.me.web.config.i18n.LanguageCloumService;
...
public enum MessageEnums {
    ...
    private LanguageCloumService cloumService;

    private Integer num;
    private String code;


    public void setCloumService(LanguageCloumService cloumService) {
